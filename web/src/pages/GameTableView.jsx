...
export default function GameTableView({ user }){
  ...
  async function saveInitiative(entry){
    const endpoint = entry.type === 'Monster' ? `/games/${id}/initiative/monsters/${entry.id}/initiative` : `/games/${id}/initiative/players/${entry.userId}`
    try{
