...
import { listGames, createGame, updateGame, invitePlayer, acceptInvitation, joinWithCode, getGame, listGameMessages, addMonster, adjustMonsterHp, removeMonster, setMonsterInitiative, toggleMonsterDead, toggleMonsterHidden, clearCombatTracker, rollPlayerInitiative, setPlayerInitiative } from '../controllers/gameController.js'
...
router.patch('/:id/initiative/monsters/:monsterId/initiative', setMonsterInitiative)
